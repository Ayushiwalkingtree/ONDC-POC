...
- Removed stale Seller/BPP wording from the FastAPI application metadata.
...
- `seller-app/` remains as a reference folder and was not modified.
...
1. Replace `InMemoryTransactionRepository` with a database-backed repository.
